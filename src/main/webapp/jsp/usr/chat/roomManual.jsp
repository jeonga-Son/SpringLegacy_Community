    ...
    <div class="container px-3 mx-auto">
        ...
        <ul class="mt-5">
            ...
            <li class="flex">
                ...
                <a onclick="if ( !confirm('정말로 삭제하시겠습니까?') ) return false;" class="hover:underline hover:text-[red] mr-2" href="/usr/chat/deleteMessage/free/${message.id}?_method=DELETE">삭제</a>
            </li>
            </c:forEach>
        </ul>
    </div>
